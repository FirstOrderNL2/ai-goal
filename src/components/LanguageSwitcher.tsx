...
export const LanguageSwitcher = React.forwardRef<HTMLButtonElement, { className?: string }>(
  ({ className = "" }, ref) => {
    ...
    return (
      <Button ref={ref} variant="ghost" size="icon" onClick={switchLang} className={`h-8 w-8 sm:w-auto sm:px-3 sm:gap-1.5 ${className}`}>
